...
/**
 * A {@link ByteToMessageDecoder} which decodes the handshake and makes changes to the pipeline as
  ...
  protected void decode(ChannelHandlerContext ctx, ByteBuf buffer, List<Object> out) {
    ...
    switch (id) {
      ...
      default:
        ...
        logger.info(String.format("Unexpected handshake request received: %d data: %s", id,
            data.toString()));
        return;
    }
