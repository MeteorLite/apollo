...
public final class PacketMetaData {
  ...
  /**
   * Creates the packet meta data object. This should not be called directly. Use the
   * {@link #createFixed}, {@link #createVariableByte}, and {@link #createVariableShort} methods
   * instead!
   *
  ...
  public int getLength() {
    Preconditions.checkState(type == PacketType.FIXED,
        "Can only get the length of a fixed length packet.");
    return length;
  }
