...
public final class PacketMetaDataGroup {
  ...
  /**
   * This constructor should not be called directly. Use the {@link #createFromArray} method
   * instead.
   */
   ...
   * @throws IllegalArgumentException If the array length is not 256, or if there is an element in
   *                                  the array with a value below -3.
   */
