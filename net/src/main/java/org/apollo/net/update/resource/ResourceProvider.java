...
public interface ResourceProvider {
   ...
   * @return {@code true} if the provider can fulfil a request to the resource, {@code false}
   * otherwise.
   ...
   * @return A {@code ByteBuffer} representation of a resource if it exists otherwise
