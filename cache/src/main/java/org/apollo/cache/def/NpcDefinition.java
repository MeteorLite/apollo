...
public final class NpcDefinition {
  ...
  public String getInteraction(int slot) {
    Preconditions.checkElementIndex(slot, interactions.length,
        "Npc interaction id is out of bounds.");
   ...
   */
  public void setWalkAnimations(int walkAnim, int walkBackAnim, int walkLeftAnim,
      int walkRightAnim) {
    this.walkAnim = walkAnim;
