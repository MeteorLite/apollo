...
public final class NameUtilTests {
  ...
  /**
   * Tests that attempting to encode an illegal character results in an
  ...
  /**
   * Tests that attempting to decode an illegal encoded value results in an
   * {@link IllegalArgumentException} being thrown.
   */
  @Test(expected = IllegalArgumentException.class)
  ...
  /**
   * Tests that encoding a String containing a space (' ') results in the space being replaced with
   * an underscore ('_').
   */
  @Test
  public void space() {
  ...
  /**
   * Tests that {@link NameUtil#decodeBase37} and {@link NameUtil#encodeBase37} perform as
   * expected.
   */
  @Test
  public void test() {
