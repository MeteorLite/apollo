...
public final class NameUtil {
   ...
   *
   * @param string The String to encode. Must not be {@code null}. Must be less than 12 characters
   *               in length.
   * @return The encoded value, as a {@code long}.
   * @throws IllegalArgumentException If the String is too long, or contains illegal characters
   *                                  ([^a-zA-Z0-9 _]).
   */
