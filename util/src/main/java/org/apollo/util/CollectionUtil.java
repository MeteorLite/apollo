...
public final class CollectionUtil {
  ...
  /**
   * Suppresses the default public constructor to discourage normal instantiation outside of this
   * class.
   */
  ...
  /**
   * Polls every element within the specified {@link Queue} and performs the specified
   * {@link Consumer} event for each element.
   *
   * @param queue    The {@link Queue} to poll elements from. Must not be {@code null}.
   * @param consumer The {@link Consumer} to execute for each polled element. Must not be
   *                 {@code null}.
   */
