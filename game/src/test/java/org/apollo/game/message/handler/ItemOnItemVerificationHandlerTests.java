...
public final class ItemOnItemVerificationHandlerTests {
  ...
  private final ItemOnItemVerificationHandler itemOnItemVerificationHandler = new ItemOnItemVerificationHandler(
      world);
  ...
  public void terminateWithNoTargetItem() throws Exception {
    ...
    ItemOnItemMessage itemOnItemMessage = new ItemOnItemMessage(BankConstants.SIDEBAR_INVENTORY_ID,
        4151, 1,
        BankConstants.SIDEBAR_INVENTORY_ID, 4152, 2);

    itemOnItemVerificationHandler.handle(player, itemOnItemMessage);

    assertTrue("ItemOnItemVerificationHandler: failed terminating message with invalid target item",
        itemOnItemMessage.terminated());
  }
}