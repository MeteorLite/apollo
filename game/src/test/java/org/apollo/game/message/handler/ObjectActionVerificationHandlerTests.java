...
@PrepareForTest({World.class, Player.class, ObjectDefinition.class, RegionRepository.class,
    Region.class})
public final class ObjectActionVerificationHandlerTests {
  ...
  public void terminateIfOutOfRange() throws Exception {
    ...
    ObjectActionVerificationHandler objectActionVerificationHandler = new ObjectActionVerificationHandler(
        world);

    objectActionVerificationHandler.handle(player, objectActionMessage);

    assertTrue("ObjectVerificationHandler: message not terminated when out of range!",
        objectActionMessage.terminated());
  }
  ...
  public void terminateIfNoObject() throws Exception {
    ...
    assertTrue("ObjectVerificationHandler: message not terminated when no object exists!",
        objectActionMessage.terminated());
  }
}