...
@PrepareForTest({Player.class, World.class, Region.class, RegionRepository.class,
...
public final class ItemOnObjectVerificationHandlerTests {
  ...
  public void terminateIfInvalidItem() throws Exception {
    ...
    ItemOnObjectMessage itemOnObjectMessage = new ItemOnObjectMessage(
        SynchronizationInventoryListener.INVENTORY_ID, 4151, 1,
        1, objectPosition.getX(), objectPosition.getY());
    ItemOnObjectVerificationHandler itemOnObjectVerificationHandler = new ItemOnObjectVerificationHandler(
        world);
  ...
  public void terminateIfInvalidSlot() throws Exception {
    ...
    ItemOnObjectMessage itemOnObjectMessage = new ItemOnObjectMessage(
        SynchronizationInventoryListener.INVENTORY_ID, 4151, 30,
        1, objectPosition.getX(), objectPosition.getY());
    ItemOnObjectVerificationHandler itemOnObjectVerificationHandler = new ItemOnObjectVerificationHandler(
        world);
