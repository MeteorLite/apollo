...
public final class AttributeTests {
  ...
  @Before
  public void setup() {
    AttributeMap.define("string_test",
        AttributeDefinition.forString("Hello world", AttributePersistence.TRANSIENT));
    AttributeMap.define("boolean_test",
        AttributeDefinition.forBoolean(true, AttributePersistence.TRANSIENT));
    AttributeMap.define("int_test",
        AttributeDefinition.forInt(Integer.MAX_VALUE, AttributePersistence.TRANSIENT));
    AttributeMap.define("long_test",
        AttributeDefinition.forLong(Long.MAX_VALUE, AttributePersistence.TRANSIENT));
    AttributeMap.define("double_test",
        AttributeDefinition.forDouble(Double.MAX_VALUE, AttributePersistence.TRANSIENT));
  }
