...
public final class MobRepositoryTests {
  ...
  /**
   * Ensures {@link Iterator#next()} for a MobRepository throws a {@link NoSuchElementException} if
   * the iterator contains no more elements.
   */
  ...
  /**
   * Ensures {@link Iterator#remove()} for a MobRepository throws an {@link IllegalStateException}
   * if remove() is called without a call to next().
   */
