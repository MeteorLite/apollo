...
public final class NpcMovementTask extends ScheduledTask {
   ...
   *
   * @param collisionManager The {@link CollisionManager} used to check if an {@link Npc} movement
   *                         is valid.
   */
  ...
  public void addNpc(Npc npc) {
    Preconditions.checkArgument(npc.hasBoundaries(),
        "Cannot add an npc with no boundaries to the NpcMovementTask.");
    npcs.offer(npc);
  }
