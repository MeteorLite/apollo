...
public final class FlaggedMouseEventMessage extends Message {
  ...
  /**
   * Indicates whether the {@link #x} and {@link #y} values represent the deviation from the last
   ...
   * @param delta      If the coordinates represent a change in x/y, rather than the values
   *                   themselves.
   */
  ...
  /**
   * Gets the value indicating whether the {@link #x} and {@link #y} values represent the deviation
   * from the last click or an actual point.
   *
   * @return The value.
   */
