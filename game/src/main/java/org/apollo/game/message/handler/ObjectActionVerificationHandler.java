...
public final class ObjectActionVerificationHandler extends MessageHandler<ObjectActionMessage> {
  ...
  /**
   * Indicates whether or not the {@link List} of {@link GameObject}s contains the object with the
   * specified id.
   *
   * @param id      The id of the object.
   * @param objects The list of objects.
   * @return {@code true} if the list does contain the object with the specified id, otherwise
   * {@code false}.
   */
  ...
  public void handle(Player player, ObjectActionMessage message) {
    ...
    Set<GameObject> objects = region.getEntities(position, EntityType.STATIC_OBJECT,
