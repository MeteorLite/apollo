...
/**
 * A {@link Message} sent by the client representing the clicking of an npc menu action. Note that
 * the actual message sent by the client is one of the three npc action messages, but this is the
