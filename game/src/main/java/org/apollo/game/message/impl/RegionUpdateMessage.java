...
/**
 * A {@link Message} that can be grouped with other Messages as part of a
 * {@link GroupedRegionUpdateMessage}.
 * <p>
 * This is a utility class for Messages that can be grouped, as is not encoded directly.
 *
 * @author Major
 */
public abstract class RegionUpdateMessage extends Message implements
    Comparable<RegionUpdateMessage> {
