...
public final class MessageHandlerChainSet {
  ...
  /**
   * The {@link Map} of {@link Message} {@link Class} types to {@link Deque}s of all Classes in the
   * chain.
   */
   ...
   */
  @SuppressWarnings("unchecked")
  public <M extends Message> void putHandler(Class<M> clazz,
      MessageHandler<? extends Message> handler) {
    MessageHandlerChain<M> chain = (MessageHandlerChain<M>) chains.computeIfAbsent(clazz,
        MessageHandlerChain::new);
