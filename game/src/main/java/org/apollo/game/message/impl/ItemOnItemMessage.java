...
/**
 * A {@link InventoryItemMessage} sent by the client when a player uses one inventory item on
 * another.
 *
...
public final class ItemOnItemMessage extends InventoryItemMessage {
   ...
   */
  public ItemOnItemMessage(int usedInterface, int usedId, int usedSlot, int targetInterface,
      int targetId, int targetSlot) {
