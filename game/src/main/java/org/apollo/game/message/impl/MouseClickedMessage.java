...
/**
 * A {@link Message} sent by the client to indicate when the mouse button/s have been clicked. This
 * can be used in combination with {@link FocusUpdateMessage} to work out if the player is clicking
