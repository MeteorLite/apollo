...
/**
 * A {@link Message} sent by the client to add an action to the menu when a player right-clicks
 * another.
 *
 * @author Major
 */
public final class SetPlayerActionMessage extends Message {
  ...
  /**
   * Whether or not this action is the primary one (i.e. should be displayed when the player hovers
  ...
  public boolean equals(Object o) {
    if (o instanceof SetPlayerActionMessage) {
      ...
      return slot == other.slot && primaryAction == other.primaryAction && Objects.equals(text,
          other.text);
