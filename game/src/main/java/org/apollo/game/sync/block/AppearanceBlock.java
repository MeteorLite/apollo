...
public final class AppearanceBlock extends SynchronizationBlock {
  ...
  AppearanceBlock(long name, Appearance appearance, int combat, int skill, Inventory equipment,
      int headIcon, boolean isSkulled) {
   ...
   * @param isSkulled  Whether or not the player is skulled.
   * @param npcId      The npc id of the player, if they are appearing as an npc, (otherwise
   *                   {@code -1}).
   */
  AppearanceBlock(long name, Appearance appearance, int combat, int skill, Inventory equipment,
      int headIcon, boolean isSkulled, int npcId) {
    this.name = name;
  ...
  /**
   * Gets the npc id the player is appearing as, or {@code -1} if the player is not appearing as
   * one.
   *
   * @return The npc id.
   */
