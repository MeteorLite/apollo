...
/**
 * A {@link SynchronizationTask} which wraps around another {@link SynchronizationTask} and notifies
 * the specified {@link Phaser} when the task has completed by calling
 * {@link Phaser#arriveAndDeregister()}.
 * <p>
 * The phaser must have already registered this task. This can be done using the
 * {@link Phaser#register()} or {@link Phaser#bulkRegister(int)} methods.
 *
 * @author Graham
 */
