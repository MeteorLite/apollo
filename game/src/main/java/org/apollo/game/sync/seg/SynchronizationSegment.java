...
/**
 * A segment contains a set of {@link SynchronizationBlock}s, {@link Direction}s (or teleport
 * {@link Position}s) and any other things required for the update of a single player.
 *
 * @author Graham
 */
