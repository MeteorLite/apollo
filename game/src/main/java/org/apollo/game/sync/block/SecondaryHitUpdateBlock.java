...
/**
 * The secondary hit update {@link SynchronizationBlock}. This is used for when multiple attacks
 * happen at once (for example, the dragon-dagger special attack). Both players and npcs can utilise
 * this block.
 *
 * @author Major
 */
