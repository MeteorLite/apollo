...
/**
 * An implementation of {@link ClientSynchronizer} which runs in a single thread (the
 * {@link GameService} thread from which this is called). Each client is processed sequentially.
 * Therefore this class will work well on machines with a single core/processor. The
 * {@link ParallelClientSynchronizer} will work better on machines with multiple cores/processors,
