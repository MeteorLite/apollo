...
public final class GameSession extends Session {
   ...
   */
  private final BlockingQueue<Message> messages = new ArrayBlockingQueue<>(
      GameConstants.MESSAGES_PER_PULSE);
  ...
  public void handlePendingMessages(MessageHandlerChainSet chainSet) {
    while (!messages.isEmpty()) {
      ...
      try {
        ...
        logger.log(Level.SEVERE, "Uncaught exception thrown while handling message: " + message,
            reason);
      }
    }
  }
