 ...
 * This is to check if
 * two actions are identical: if they are, then the new action does not replace the old one (so
 * spam/accidental clicking won't cancel your action, and start another from scratch).
 *
