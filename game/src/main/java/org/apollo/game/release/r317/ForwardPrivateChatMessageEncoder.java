 ...
 * @author Major
 */
public final class ForwardPrivateChatMessageEncoder extends
    MessageEncoder<ForwardPrivateChatMessage> {

  /**
   * The amount of messages sent globally, offset by a random variable x,
   * {@code 0 <= x < 100,000,000}.
   */
  private static AtomicInteger messageCounter = new AtomicInteger(
      (int) (Math.random() * 100_000_000));
