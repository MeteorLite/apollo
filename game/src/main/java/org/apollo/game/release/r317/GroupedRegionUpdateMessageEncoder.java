 ...
 * @author Major
 */
public final class GroupedRegionUpdateMessageEncoder extends
    MessageEncoder<GroupedRegionUpdateMessage> {
   ...
   *
   * @param release The {@link Release} containing the {@link MessageEncoder}s for the
