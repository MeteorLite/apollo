 ...
 * @author Major
 */
public final class NpcSynchronizationMessageEncoder extends
    MessageEncoder<NpcSynchronizationMessage> {
   ...
   */
  private static void putAddNpcUpdate(AddNpcSegment seg, NpcSynchronizationMessage message,
  ...
  private static void putAnimationBlock(AnimationBlock block, GamePacketBuilder builder) {
    builder.put(DataType.SHORT, DataOrder.LITTLE, block.getAnimation());
    builder.put(DataType.BYTE, block.getDelay());
  }
   ...
   * @param builder The builder.
   */
  private static void putMovementUpdate(SynchronizationSegment segment,
      NpcSynchronizationMessage message, GamePacketBuilder builder) {
