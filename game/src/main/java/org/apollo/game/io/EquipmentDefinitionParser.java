...
/**
 * A class that parses the {@code data/equipment-[release].dat} file to create an array of
 * {@link EquipmentDefinition}s.
 *
 * @author Graham
 */
public final class EquipmentDefinitionParser implements Runnable {
  ...
  /**
   * Creates an {@link EquipmentDefinitionParser} that reads from the file located at the specified
   * {@code path}.
   *
