...
/**
 * An interface which may be implemented by others which are capable of serializing and
 * deserializing players. For example, implementations might include text-based, binary and SQL
 * serializers.
 *
 * @author Graham
 * @author Major
