 ...
 * <p>
 * This class manages all six distinct types of interface (the last two are not present on 317
 * servers).
 * <p>
 * <ul>
...
public final class InterfaceSet {
  ...
  /**
   * Called when the player has clicked the specified button. Notifies the current dialogue
   * listener.
   *
  ...
  /**
   * An internal method for closing the interface, notifying the listener if appropriate, but not
