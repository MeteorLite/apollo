...
/**
 * A {@link RegionListener} that listens to object addition/removals and applies the respective
 * {@link CollisionUpdate}.
 */
public final class CollisionUpdateListener implements RegionListener {
   ...
   *
   * @param collisionManager The {@link CollisionManager} that collision updates will be applied
   *                         to.
   */
