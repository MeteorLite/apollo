...
/**
 * An enumeration representing the brightness of a player's screen. This enumeration relies on the
 * ordering of the elements within, which should be as follows: {@code DARK}, {@code NORMAL},
 * {@code BRIGHT}, {@code VERY_BRIGHT}.
 *
 * @author Major
 */
public enum ScreenBrightness {
  ...
  public static ScreenBrightness valueOf(int value) {
    ...
    Preconditions.checkElementIndex(value, values.length,
        "Invalid screen brightness integer value specified " + value + ".");
    return values[value];
  }
