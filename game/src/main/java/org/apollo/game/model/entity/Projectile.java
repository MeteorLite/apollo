...
public final class Projectile extends Entity implements GroupableEntity {
  ...
  /**
   * The starting height of the projectile, relative to the height of the tile the Projectile starts
   * on.
   */
   ...
   * @param graphic     The id of the graphic played as the Projectile proceeds. Must not be
   *                    negative.
   ...
   * @param startHeight The starting height of the projectile, relative to the height of the
   *                    {@code source} tile.
   * @param target      The index of the target Mob (or 0 if the Projectile is not targeting a
   *                    Mob).
   */
  public Projectile(World world, Position source, int delay, Position destination, int endHeight,
      int graphic, int lifetime,
  ...
  /**
   * Gets the index of the {@link Mob} this Projectile is targeting, or 0 if this Projectile is not
   * targeting a {@link Mob}.
   *
   * @return The index.
   */
  ...
  public ProjectileUpdateOperation toUpdateOperation(Region region, EntityUpdateType type) {
    Preconditions.checkArgument(type == EntityUpdateType.ADD,
        "Projectiles cannot be removed from the client");
  ...
  public static final class ProjectileBuilder {
    ...
    /**
     * The ending height of the projectile. Defaults to the most commonly used ending height (for
     * arrows and combat magic).
     */
    ...
    /**
     * The pitch of the Projectile as it climbs. Defaults to the most commonly used pitch (for
     * arrows and combat magic).
     */
    ...
    /**
     * The starting height of the projectile, relative to the height of the tile the Projectile
     * starts on. Defaults to the most commonly used starting height (for arrows and combat magic).
     */
    ...
    private int target;
    /**
     * The offset from the center of the {@code source} tile in world units. Defaults to 1/2 of a
     * tile (or a {@link Mob} with a size of 1).
     */
     ...
     * @throws NullPointerException     If the source or destination {@link Position}s are
     *                                  {@code null}.
     */
    ...
    /**
     * Sets the end height of the {@link Projectile}. Note that this is the height in 'world
     * units',
    ...
    /**
     * Sets the starting height of the {@link Projectile}, relative to the height of the origin tile
     * (so a value of 0 fires the {@link Projectile} from the exact height of the origin tile). Note
     * that this is the height in 'world units', <strong>not</strong> the height as described in
     * {@link Position}s.
     *
     * @param height The start height of the {@link Projectile}. Must be
     *               {@code 0 <= height <= 255}.
     * @return This {@link ProjectileBuilder}, for chaining. Will never be {@code null}.
     */
