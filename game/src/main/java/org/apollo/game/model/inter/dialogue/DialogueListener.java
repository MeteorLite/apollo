...
public interface DialogueListener extends InterfaceListener {
   ...
   * <p>
   * Note that this method is invoked when any button is clicked whilst the dialogue is opened. In
   * case the button is not being handled by this listener, simply return {@code false} to allow
   * further processing of the message.
   * </p>
   *
   * @param button The button interface id.
   * @return {@code true} if the {@link MessageHandlerChain} should be broken, {@code false} if it
   * should be continued.
   */
