...
public final class RegionRepository {
  ...
  /**
   * A list of default {@link RegionListener}s which will be added to {@link Region}s upon
   * creation.
   */
   ...
   *                                       mapped (and hence the existing Region would be replaced),
   *                                       and removal of regions is not permitted.
   */
  ...
  /**
   * Adds a {@link RegionListener} to be registered as a default listener with all newly created
   * {@link Region}s and associated with any existing instances.
   *
