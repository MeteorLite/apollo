...
/**
 * Represents the status of the friend server. This enumeration relies on the ordering of the
 * elements within, which should be as follows: {@code OFFLINE}, {@code CONNECTING},
 * {@code ONLINE}.
 *
 * @author Major
 */
public enum ServerStatus {
  ...
  public static ServerStatus valueOf(int value) {
    ...
    Preconditions.checkElementIndex(value, values.length,
        "Invalid server status integer value supplied " + value + ".");
    return values[value];
  }
