...
public final class Skill {
  ...
  /**
   * Creates a skill from an existing skill, using the existing skill's experience and maximum level
   * values, but the specified current level.
   *
   * @param currentLevel The current level.
  ...
  /**
   * Creates a skill from an existing skill, using the existing skill's current and maximum level
   * values, but the specified experience.
   *
   * @param experience The experience.
   * @param skill      The existing skill.
  ...
  /**
   * Creates a skill from an existing skill, using the existing skill's experience and current level
   * values, but the specified maximum level.
   *
