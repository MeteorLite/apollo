 ...
 * <p>
 * This is a workaround for JRuby issue <a
 * href="https://github.com/jruby/jruby/issues/2359">2359</a>.
 *
 * @author Major
 */
public final class ProxyEventListener implements EventListener<ProxyEvent> {
  ...
  /**
   * Registers an {@link EventListener} to this proxy. This method is <strong>not</strong>
   * type-safe, and must only be called from ruby.
   *
  ...
  public void add(String name, EventListener<Event> listener) {
    List<EventListener<Event>> listeners = this.listeners.computeIfAbsent(name,
        n -> new ArrayList<>(2));
