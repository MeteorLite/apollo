...
public final class SkillSet {
  ...
  public static int getExperienceForLevel(int level) {
    Preconditions.checkArgument(level >= 1 && level <= 99,
        "Level must be between 1 and 99, inclusive.");
   ...
   */
  private void init() {
    Arrays.setAll(skills,
        id -> id == Skill.HITPOINTS ? new Skill(1154, 10, 10) : new Skill(0, 1, 1));
  }
