...
/**
 * An enumeration with the different privilege levels a player can have. This enumeration relies on
 * the ordering of the elements within, which should be as follows: {@code STANDARD},
 * {@code MODERATOR}, {@code ADMINISTRATOR}.
 *
 * @author Graham
 */
public enum PrivilegeLevel {
  ...
  public static PrivilegeLevel valueOf(int value) {
    ...
    Preconditions.checkElementIndex(value, values.length,
        "Invalid privilege level integer value supplied " + value + ".");
    return values[value];
  }
