...
public final class AttributeDefinition<T> {
   ...
   */
  public static AttributeDefinition<Boolean> forBoolean(boolean defaultValue,
   ...
   * @return The AttributeDefinition.
   */
  public static AttributeDefinition<Double> forDouble(double defaultValue,
      AttributePersistence persistence) {
   ...
   * @return The AttributeDefinition.
   */
  public static AttributeDefinition<Integer> forInt(int defaultValue,
      AttributePersistence persistence) {
   ...
   * @return The AttributeDefinition.
   */
  public static AttributeDefinition<Long> forLong(long defaultValue,
      AttributePersistence persistence) {
    return new AttributeDefinition<>(defaultValue, persistence, AttributeType.LONG);
  }
   ...
   * @return The AttributeDefinition.
   */
  public static AttributeDefinition<String> forString(String defaultValue,
      AttributePersistence persistence) {
