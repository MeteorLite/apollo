...
/**
 * A {@link Map} wrapper used to store {@link Attribute}s and their
 * {@link AttributeDefinition definitions}.
 *
 * @author Major
 */
public final class AttributeMap {
  ...
  /**
   * Gets the {@link AttributeDefinition} with the specified name, or {@code null} if it is not
   * defined.
   *
   * @param name The name of the attribute.
  ...
  public <T> Attribute<T> get(String name) {
    ...
    Preconditions.checkNotNull(definition,
        "Attributes must be defined before their value can be retreived.");
  ...
  public void set(String name, Attribute<?> attribute) {
    Preconditions.checkNotNull(getDefinition(name),
        "Attributes must be defined before their value can be set.");
