...
public enum Direction {
  ...
  /**
   * An array of directions without any diagonal directions, and one step counter-clockwise, as used
   * by the clients collision mapping.
   */
  public final static Direction[] WNES = {WEST, NORTH, EAST, SOUTH};

  /**
   * An array of diagonal directions, and one step counter-clockwise, as used by the clients
   * collision mapping.
   */
  ...
  /**
   * Gets the direction as an integer as used orientation in the client maps (WNES as opposed to
   * NESW).
   *
