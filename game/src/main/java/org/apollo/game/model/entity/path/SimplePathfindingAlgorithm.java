...
/**
 * A very simple pathfinding algorithm that simply walks in the direction of the target until it
 * either reaches it or is blocked.
 *
 * @author Major
 */
public final class SimplePathfindingAlgorithm extends PathfindingAlgorithm {
   ...
   */
  private Deque<Position> addHorizontal(Position start, Position target,
    ...
    if (!last.equals(target) && dy != 0 && traversable(last, boundaries,
