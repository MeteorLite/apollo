...
public final class DynamicGameObject extends GameObject {
   ...
   * @param alwaysVisible The flag indicates whether or not this DynamicGameObject is visible to
   *                      every player.
   */
   ...
   */
  public static DynamicGameObject createLocal(World world, int id, Position position, int type,
      int orientation) {
