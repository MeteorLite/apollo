...
public final class PluginManager {
  ...
  private static Map<String, PluginMetaData> createMap(Collection<PluginMetaData> plugins) {
    Map<String, PluginMetaData> map = plugins.stream()
        .collect(Collectors.toMap(PluginMetaData::getId, Function.identity()));
  ...
  public void start() throws IOException, SAXException, DependencyException {
    ...
    PluginEnvironment env = new KotlinPluginEnvironment(
        world); // TODO isolate plugins if possible in the future!
