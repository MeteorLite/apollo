...
/**
 * A decoder which loads {@link MapFile}s and notifies the {@link CollisionManager} of tiles which
 * are blocked, or on a bridge.
 */
public final class WorldMapDecoder implements Runnable {
  ...
  /**
   * Mark any tiles in the given {@link MapPlane} as blocked or bridged in the
