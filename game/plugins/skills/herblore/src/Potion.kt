...
enum class FinishedPotion(
    ...
    ANTIPOISON(
            id = 175,
            unfinished = MARRENTILL,
            ingredient = UNICORN_HORN,
            level = 5,
            experience = 37.5
    ),
    STRENGTH(
            id = 115,
            unfinished = TARROMIN,
            ingredient = LIMPWURT_ROOT,
            level = 12,
            experience = 50.0
    ),
    RESTORE(
            id = 127,
            unfinished = HARRALANDER,
            ingredient = RED_SPIDERS_EGGS,
            level = 18,
            experience = 62.5
    ),
    ENERGY(
    ...
    WEAPON_POISON(
            id = 187,
            unfinished = KWUARM,
            ingredient = DRAGON_SCALE,
            level = 60,
            experience = 137.5
    ),
    SUPER_RESTORE(
            id = 3026,
            unfinished = SNAPDRAGON,
            ingredient = RED_SPIDERS_EGGS,
            level = 63,
            experience = 142.5
    ),
    ...
    RANGING(
            id = 169,
            unfinished = DWARF_WEED,
            ingredient = WINE_ZAMORAK,
            level = 72,
            experience = 162.5
    ),
    MAGIC(
    ...
    companion object {
        private val potions =
                FinishedPotion.values().associateBy { Pair(it.unfinished.id, it.ingredient) }
