...
class SpawnTests {
    ...
    fun `spawned npcs are facing the correct direction`(
            id: Int,
            name: String,
            spawn: Position,
            direction: Direction
        ...
        val npc =
                requireNotNull(world.npcRepository.find { it.id == id }) { "Failed to find npc $name with id $id." }
    ...
    fun `spawned npcs are playing the correct animation`(
            id: Int,
            name: String,
            spawn: Position,
            animation: Animation
    ...
    fun `spawned npcs are playing the correct graphic`(
            id: Int,
            name: String,
            spawn: Position,
            graphic: Graphic
    ...
    companion object {
        ...
        fun `npcs spawned by id with directions`(): List<Arguments> {
            return npcs.filterNot { it.id == null }
                    .map { (id, name, position, direction) ->
                        Arguments.of(
                                id,
                                name,
                                position,
        ...
        fun `npcs spawned by id with animations`(): List<Arguments> {
            return npcs.filterNot { it.id == null }
                    .map { (id, name, position, _, animation) ->
                        Arguments.of(
                                id,
                                name,
                                position,
        ...
        fun `npcs spawned by id with graphics`(): List<Arguments> {
            return npcs.filterNot { it.id == null }
                    .map { (id, name, position, _, _, graphic) ->
                        Arguments.of(
                                id,
                                name,
                                position,
        ...
        private val npcs = listOf(
                Spawn(
                        ...
                        spawnAnimation = Animation(10, 100)
                ),
                Spawn(
                        1,
                        "man",
                        Position(1000, 1000, 0),
                        facing = Direction.NORTH,
                        spawnGraphic = Graphic(154, 0, 100)
                ),
                ...
                Spawn(
                        6,
                        "fakename123",
                        Position(1500, 1500, 3),
                        facing = Direction.EAST,
                        spawnAnimation = Animation(112)
                ),
                Spawn(
                        12,
                        "fakename123",
