...
class OpenShopAction(
        ...
        operator.position,
        1
) { // TODO this needs to follow the NPC if they move
    ...
    override fun executeAction() {
        ...
        mob.interfaceSet.openWindowWithSidebar(
                closeListener, ShopInterfaces.SHOP_WINDOW,
    ...
    private fun addInventoryListeners(player: Player, shop: Inventory): InterfaceListener {
        val invListener =
                SynchronizationInventoryListener(player, ShopInterfaces.INVENTORY_CONTAINER)
